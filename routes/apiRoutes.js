...
module.exports = function(app) {
  ...
  // routing for the WWWMB page
  app.get("/wwwmb/:symps", function(req, res) {
    console.log("what the server sees: ", req.params.symps);
    var symptoms = req.params.symps;
    // rapidAPI and APImedic call
    // we pass in our array of symptoms generated by the user
    unirest
      .get(
